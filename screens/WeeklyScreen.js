...
export default function WeeklyScreen() {
  ...
  useEffect(() => {
    loadFromStorage(setTimeEntries, setRate);
  }, []);
  ...
  const handleReset = async () => {
    ...
    try {
      await deleteAllStorageEntries(setTimeEntries, setRate);
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <Button title="Reset" onPress={handleReset} color="#f44336" />
        <View style={{ height: 10 }} />
        <Button title="Save" onPress={() => saveToStorage(timeEntries, rate)} color="#2196F3" />
      </View>
...
const styles = StyleSheet.create({
  container: { padding: 16, backgroundColor: '#f9f9ff' },
  title: { fontSize: 24, fontWeight: 'bold', marginBottom: 16, textAlign: 'center', color: '#2c3e50' },
  rateContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  rateLabel: { fontSize: 14, fontWeight: '600', color: '#333', marginRight: 10 },
  rateInput: { borderWidth: 1, borderColor: '#aaa', padding: 6, borderRadius: 6, backgroundColor: '#eef', textAlign: 'center', fontSize: 13 },
  tableHeader: { flexDirection: 'row', backgroundColor: '#d0d9ff', padding: 10, borderRadius: 10, marginBottom: 8 },
  tableCol: { flex: 1, fontWeight: 'bold', color: '#333', textAlign: 'center', fontSize: 12 },
  tableRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', paddingVertical: 8, marginBottom: 5, borderRadius: 8, shadowColor: '#ccc', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  dayText: { flex: 1, textAlign: 'center', fontWeight: '600', color: '#34495e', fontSize: 13 },
  timeInputContainer: { flex: 1, flexDirection: 'row', alignItems: 'center', marginHorizontal: 2 },
  input: { flex: 1, borderWidth: 1, borderColor: '#bbb', padding: 6, borderRadius: 6, backgroundColor: '#f2f2f2', fontSize: 8 },
  picker: { marginLeft: 4, paddingHorizontal: 6, paddingVertical: 6, backgroundColor: '#ddeeff', borderRadius: 6 },
  pickerText: { fontSize: 12, fontWeight: '600', color: '#2c3e50' },
  hoursText: { flex: 1, textAlign: 'center', fontWeight: '600', fontSize: 13, color: '#2d3436' },
  leaveText: { color: '#e74c3c', fontWeight: 'bold' },
  salaryText: { flex: 1, textAlign: 'center', fontSize: 13, fontWeight: '600', color: '#34495e' },
  buttonContainer: { marginVertical: 20 },
  resultContainer: { backgroundColor: '#e8f5e9', padding: 15, borderRadius: 10, marginBottom: 30 },
  resultText: { fontSize: 16, marginBottom: 5, fontWeight: '600', color: '#2c3e50' },
  helpButtonContainer: { position: 'absolute', top: 40, right: 0 },
  helpButton: { backgroundColor: '#007bff', padding: 10, borderRadius: 20 },
  helpButtonText: { color: 'white', fontWeight: 'bold' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'center', alignItems: 'center' },
  modalContent: { width: '85%', backgroundColor: 'white', padding: 20, borderRadius: 10, position: 'relative' },
  closeButton: { position: 'absolute', right: 10, top: 5, zIndex: 10 },
  closeButtonText: { color: 'red', fontSize: 20, fontWeight: 'bold' },
  helpTitle: { fontSize: 20, fontWeight: 'bold', marginBottom: 10, textAlign: 'center', color: '#333' },
  helpText: { fontWeight: 'bold', marginTop: 10, marginBottom: 4, color: '#222' },
  helpBullet: { marginLeft: 10, color: '#555' },
});
